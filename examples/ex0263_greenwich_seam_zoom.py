...
Last Tested
-----------
16 Jun 2026 0.1.3a0 (passed) 8.7s
23 May 2026
"""
import numpy as np
...
SEAM_WINDOW = np.array([
    [51.4799999, -0.00000015],
    [51.4799999,  0.00000015],
    [51.4800001,  0.00000015],
    [51.4800001, -0.00000015],
])
...
if __name__ == '__main__':
    ...
    mesh = HexMesh.create_clipped([22], SEAM_WINDOW, reg)
    print(mesh)

    lonlat = reg.project(mesh.pts, [b_oct, g_gcd]).coords

    plot_seam_zoom(mesh, lonlat, SEAM_WINDOW, f'ex0263_seam_zoom_L{finest}')
